...
void GUI_Process(uint16 fps)
{
    ...
    if(g_display_mode == GUI_MODE_IMAGE_AND_MAIN_INFO)
    {
        ...
        ips200_show_int32(60, 170, (int32) mycar.RUNTIME, 4);
        ips200_show_int32(40, 185, (int32)watch.cross_flag, 4);
        ips200_show_int32(40, 200, (int32)watch.zebra_flag, 4);
        ...
        ips200_show_string(0, 170, "RUNTIME");
        ips200_show_string(0, 185, "cross");
        ips200_show_string(0, 200, "zebra");
    }
}
